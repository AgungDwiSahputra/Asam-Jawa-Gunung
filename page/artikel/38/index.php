            ...
            <div class="col-md-10">
              ...
              <div class="post mb-0 pb-2">
                <div class="post-image">
                  <img class="img-fluid d-block mx-auto rounded w-50" src="../../../<?= $isi['gambar37'] ?>" alt="post image" style="object-fit:cover;min-width:80% !important;height:70vh">
                </div>
                <div class="post-title">
                  <h4><?= $isi['judul37'] ?></h4>
                </div>
                <div class="post-meta">
                    <span class="post-date"><?= $artikel['ttl37'] ?></span>
